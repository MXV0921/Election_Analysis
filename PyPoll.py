...
with open(file_to_load) as election_data:
    ...
    # If the candidate does not match any existing conditions...
...
# After printint the final vote to the terminal save the final vote count to the text file
    for candidate_name in candidate_votes:
        ...
        # Print each candidate results to text file.
    ...
    # Print teh winning candidates results to the terminal.
